...
export default function ClassroomPage() {
  return (
    <PageContainer>
      ...
      <div className="mt-16 bg-gradient-to-r from-espresso-panel via-espresso-raised to-espresso rounded-3xl p-8 md:p-12 text-center max-w-4xl mx-auto border border-espresso-line shadow-sm">
        <h3 className="font-display text-2xl md:text-3xl font-bold text-rose mb-4">
          Muốn học trong môi trường chuyên nghiệp này?
        </h3>
        <p className="text-rose-muted text-base md:text-lg mb-8 max-w-2xl mx-auto">
