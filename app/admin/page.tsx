      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="bg-white border text-ink border-border-soft shadow-sm mb-8 w-full justify-start overflow-x-auto p-1 h-auto py-2">
            ...
            <TabsTrigger value="course_info" className="whitespace-nowrap rounded-md px-4 py-2 data-[state=active]:bg-amber-500 data-[state=active]:text-white">ℹ️ Thông Tin Khóa Học</TabsTrigger>
          </TabsList>
