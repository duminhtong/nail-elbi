...
export default function YoutubeCTA({ title }: { title: string }) {
  ...
  return (
    <div className="bg-gradient-to-r from-espresso-panel via-espresso-raised to-espresso border border-espresso-line rounded-2xl p-6 md:p-8 text-center max-w-4xl mx-auto mb-10 w-full shadow-sm">
      ...
      <h2 className="font-display text-xl md:text-2xl font-bold text-rose mb-2">
        {title}
      </h2>
      <p className="text-rose-muted text-sm md:text-base mb-6 max-w-lg mx-auto">
